...
FRAME_WIDTH  = 1280        # Captured frame width  (pixels)
FRAME_HEIGHT = 720        # Captured frame height (pixels)
...
LINE_HSV_LOWER = (0, 0, 0)
LINE_HSV_UPPER = (180, 238, 139)
...
# Increased to 3000 to prevent robot shadows or table edges from being detected as the line.
LINE_MIN_CONTOUR_AREA = 3000   # pixels²
...
LINE_LOOKAHEAD_RADIUS = 300  # pixels
...
SPEED_FORWARD = 25    # slider value for straight driving
SPEED_TURN    = 25      # slider value when turning
SPEED_STOP    = 0
...
ESP32_BASE_URL = "http://10.42.0.112"   # ← replace with your ESP32's IP address
ESP32_TIMEOUT  = 1    # seconds – keep short so the control loop isn't blocked
